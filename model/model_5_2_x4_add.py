...
class net_total(nn.Module):
    ...
    def forward(self, x_img, x_text):
        HR_2x_text, HR_4x_text = self.text(x_text)
        HR_2x_img, HR_4x_img = self.image(x_img)

        HR_4x_text_edge = self.Edge_Enhancement(HR_4x_text)
        HR_4x_text__out = 0.1 * HR_4x_text_edge + HR_4x_text
        x2 = HR_2x_img + HR_2x_text
        x4 = HR_4x_img + HR_4x_text__out

        return HR_2x_text, HR_2x_img, HR_4x_text__out, HR_4x_img, x2, x4, HR_4x_text_edge
